...
/*
 * Access Modifier의 지정 범위를 알아보는 로직을 작성.
...
public class Parent {
    ...
    // 이 떄 만약 내가 명시적 생성자를 넣어주면 그때는 기본 생성자가 자동적으로 제공되지 않는다.
    // 기본 생성자 : public Parent() {}
    // 그래서 만약에 기본 생성자가 반드시 필요한 경우라면 꼭 명시적으로 기본 생성자를 코드로 작성해야한다.
